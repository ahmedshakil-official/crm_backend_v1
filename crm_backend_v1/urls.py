...
from case.views import MortgageCasesOfferedAPIView
...
urlpatterns = [
    ...
    path(
        "networks/<int:network_id>/dashboard/mortgage-cases-offered/",
        MortgageCasesOfferedAPIView.as_view(),
        name="mortgage-cases-offered",
    ),
]
