...
from case.views import InsuranceCasesSubmittedStatsView
...
urlpatterns = [
    ...
    path(
        "network/insurance-cases-submitted/",
        InsuranceCasesSubmittedStatsView.as_view(),
        name = "insurance-cases-submitted",
    ),
]
