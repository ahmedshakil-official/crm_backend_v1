...
class OtherIncomeSourceChoice(models.TextChoices):
    ...
    CHILD_MAINTENANCE_NON_COURT_ORDERED = "CHILD_MAINTENANCE_NON_COURT_ORDERED", _(
    ...
    EMPLOYMENT_AND_SUPPORT_ALLOWANCE = "EMPLOYMENT_AND_SUPPORT_ALLOWANCE", _("Employment and Support Allowance (ESA)")
    MAINTENANCE_INCOME = "MAINTENANCE_INCOME", _("Maintenance Income")
    PERSONAL_INDEPENDENCE_PAYMENTS = "PERSONAL_INDEPENDENCE_PAYMENTS", _("Personal Independence Payments (PIP)")
