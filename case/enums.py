...
class ExtraAnswerChoices(models.TextChoices):
    YOUR_CIRCUMSTANCES_AND_OBJECTIVES = "YOUR_CIRCUMSTANCES_AND_OBJECTIVES", _(
...
class OtherIncomeSourceChoice(models.TextChoices):
    CARERS_ALLOWANCE = "CARERS_ALLOWANCE", _("CARER'S ALLOWANCE")
    CHILD_BENEFIT = "CHILD_BENEFIT", _("Child Benefit")
    CHILD_MAINTENANCE_COURT_ORDERED = "CHILD_MAINTENANCE_COURT_ORDERED", _("CHILD MAINTENANCE COURT ORDERED")
    CHILD_MAINTENANCE_NON_COURT_ORDERED = "CHILD_MAINTENANCE_NON_COURT_ORDERED", _("CHILD_MAINTENANCE NON COURT ORDERED")
    CHILD_TAX_CREDITS = "CHILD_TAX_CREDITS", _("CHILD TAX CREDITS")
    DISABILITY_LIVING_ALLOWANCE = "DISABILITY_LIVING_ALLOWANCE", _("DISABILITY LIVING ALLOWANCE(DLA)")
    EMPLOYMENT_AND_SUPPORT_ALLOWANCE = "EMPLOYMENT_AND_SUPPORT_ALLOWANCE(ESA)", _("EMPLOYMENT AND SUPPORT ALLOWANCE(ESA)")
    MAINTENANCE_INCOME = "MAINTENANCE_INCOME", _("MAINTENANCE INCOME")
    PERSONAL_INDEPENDENCE_PAYMENTS = "PERSONAL_INDEPENDENCE_PAYMENTS(PIP)", _("PERSONAL INDEPENDENCE PAYMENTS (PIP)")
    MATERNITY_PAY = "MATERNITY_PAY", _("MATERNITY PAY")
    PENSION_CREDIT = "PENSION_CREDIT", _("PENSION CREDIT")
    RENTAL_INCOME = "RENTAL_INCOME", _("RENTAL INCOME")
    WORKING_TAX_CREDITS = "WORKING_TAX_CREDITS", _("WORKING TAX CREDITS")
    OTHER = "OTHER", _("OTHER")